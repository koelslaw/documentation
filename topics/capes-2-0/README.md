...
* [Post Installation](https://nuc.simplerock.lan:4000/capes/capes/tree/master/docs#post-installation)
...
1. Select the hard disk you want to install RHEL/CENTOS to, likely it is already selected unless you have more than 1 drive  
...
### Update Repository
Once CAPES reboots we need to set the Nuc as the upstream RHEL/CENTOS repository You can copy / paste this following code block into the Terminal (once you update the `.[state octet].` with your [octet](../README.md)).
